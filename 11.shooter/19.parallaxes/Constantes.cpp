...
const int Constantes::VAISSEAU_VIES { 5 };
const float Constantes::DUREE_GAME_OVER { 2.0f };
...
const int Constantes::ENNEMI_VIES { 2 };
...
const int Constantes::BOSS_VIES { 100 };

// Entree-Sortie
const float Constantes::VITESSE_PLACEMENT { 800.0f };
const int Constantes::NB_VAGUES { 3 };
